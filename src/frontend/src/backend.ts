...
export class Backend implements backendInterface {
    ...
    async getLeaderboard(): Promise<Array<GameResult>> {
    ...
    async getPlayerGames(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerGames();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRecentGames(): Promise<Array<GameResult>> {
        if (this.processError) {
            try {
    ...
    async getResult(arg0: bigint): Promise<GameResult> {
        if (this.processError) {
            try {
    ...
    async submitGame(arg0: string, arg1: bigint, arg2: bigint, arg3: boolean): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitGame(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
